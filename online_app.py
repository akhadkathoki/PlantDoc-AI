...
from utils.grok_handler import get_disease_report, get_chatbot_answer
...
# ================= ABOUT ================= #
    ...
    with col_right:
        ...
        st.info("**Reports:** Powered by **Groq LLaMA-3 AI** to generate detailed care instructions and farming guidance.")
